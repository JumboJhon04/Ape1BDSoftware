...
function getPrestamoStatusClass(status) {
...
function DashboardPage() {
  ...
  const summaryCards = useMemo(() => {
    ...
    // Evita doble conteo: los vencidos son subconjunto de prestados.
        ...
        {mantenimientosActivos.length > 0 ? (
          <div className="dashboard-pagination-row">
            ...
            <button
              ...
              className="dashboard-page-button"
              onClick={() =>
                setMantenimientosPage((prev) => Math.min(totalMantenimientosPages, prev + 1))
              }
